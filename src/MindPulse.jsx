...
const getZodiacFromDate = (month, day) => {
  const dates = [[20,19],[19,20],[21,20],[20,20],[21,21],[21,22],[23,22],[23,22],[23,22],[23,21],[22,21],[22,19]];
  const signs = ZODIAC_SIGNS;
  const idx = (day >= dates[month - 1][0]) ? month - 1 : (month - 2 + 12) % 12;
  return signs[idx];
};
...
// ─── STYLES ───
const FONTS = `
@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;1,300;1,400&family=DM+Sans:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400&family=Space+Mono:wght@400;700&display=swap');
`;
